 ...
 class CoreMailPage extends Page{
	...
	*/
	public function getXMLModuleFileConfiguration(){
		return Ressource::getCurrentTemplate()->getFile(new File('xml/page/mail/'.$this->mailTarget,'modules.xml',false));
	}
	/**
	...
	*/
	public function getConfigurationFile(){
		return Ressource::getCurrentTemplate()->getFile(new File("xml/page/mail/".$this->mailTarget,"configuration.xml",false));
	}
	/**
	...
	*/
	public function getHookDescriptionFile($name,$silent=false){
		return Ressource::getCurrentTemplate()->getFile(new File("xml/page/mail/".$this->mailTarget."/hook",$name.".xml",false),$silent);
	}
}
