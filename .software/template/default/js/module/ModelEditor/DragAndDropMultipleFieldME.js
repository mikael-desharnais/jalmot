jQuery(document).ready(function(){
	jQuery(".dragAndDropMultipleFieldME .element .delete").live('click',function(event){
	...
	jQuery('body').bind('draggablestop',function(event,draggable,droppable){
		if (jQuery(droppable).hasClass('dragAndDropMultipleFieldME')&&(jQuery(droppable).data('target-type')==draggable.data('draggable-type'))){
